        ...
        <div class="flex flex-wrap justify-center">
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <div class="font-semibold bg-pink-900 text-gray-100 py-3 px-6 mb-0">
                        {{ __('Register') }}
                    </div>
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="flex flex-wrap">
                            <button type="submit" class="inline-block align-middle text-center select-none border font-bold whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-gray-100 bg-pink-900 hover:bg-pink-800">
                                {{ __('Register') }}
                            </button>
